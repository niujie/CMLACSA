...
def subset_basis(vlist):
    ...
    '''
    vstar = orthogonalize(vlist)
    return [vlist[i] for i in range(len(vstar)) if vstar[i]*vstar[i] > 1e-20]
...
least_squares_c1 = least_squares_Q1.transpose() * least_squares_b1
x_hat_1 = solve(least_squares_R1, least_squares_c1)
...
least_squares_c2 = least_squares_Q2.transpose() * least_squares_b2
x_hat_2 = solve(least_squares_R2, least_squares_c2)
